    ...
    return (
        <section id="home" className="min-h-screen flex items-center justify-center relative">
            <div className="text-center z-10 px-4">
                <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-300 to-cyan-400 bg-clip-text text-transparent leading-right">
                    Hello, I'm Joao Lucas Veras
                </h1>
                <p className="text-grey-400 text-lg mb-8 max-w-lg mx-auto">
                Software Engineering major at San Jose State University, passionate about AI, game development, and full-stack engineering—building intelligent, immersive, and scalable applications.
                </p>
